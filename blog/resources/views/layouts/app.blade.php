...
<head>
    ...
    <title>{{ config('app.name', 'Moviz') }}</title>
                        ...
                        @else
                            <li class="nav-item dropdown row">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <div class="profile-header-container mr-2">
                                        ...
                                        @else
                                            <img class="rounded-circle" width="30px" height="30px" src="/storage/avatars/{{ Auth::user()->avatar }}" />
                                        @endif
                                        </div>
                                    </div>
